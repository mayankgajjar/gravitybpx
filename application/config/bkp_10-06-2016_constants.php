...
define ("TABLE_NAME", serialize (array ("notifications" => "notifications","category" => "category","notifications_type" => "notifications_type","notifications_message" => "notifications_message","theme_options" => "theme_options")));
