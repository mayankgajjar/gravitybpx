...
class Campaign extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->data['title'] = 'Admin | Campaign';
		$this->template->load('admin','campaign/list_campaign',$this->data);
	}
        ...
        if ($rResult) {
            foreach ($rResult as $aRow) {
                ...
                for ($i = 0; $i < count($bColumns); $i++) {
                 ...
                 $row[] = '<a href="' . site_url('adm/campaign/edit/'. encode_url($aRow['campaign_id'])) . '" title="Edit"><i class="fa  fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a class="delete" href="' . site_url('adm/campaign/delete/'.encode_url($aRow['campaign_id'])) . '" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>&nbsp;&nbsp;<a href="' . site_url('adm/campaign/archive/'.encode_url($aRow['campaign_id'])) . '" title="Archive"><i class="fa fa-archive" aria-hidden="true"></i></a>';
    ...
    public function archiveindex()
    {
        $this->data['datatable'] = TRUE;
        $this->data['sweetAlert'] = TRUE;
        $this->data['title'] = 'Admin | Archive Campaign';
        $this->template->load('admin','campaign/list_archive_campaign',$this->data);
    }
        ...
        if ($rResult) {
            foreach ($rResult as $aRow) {
                ...
                for ($i = 0; $i < count($bColumns); $i++) {
                 ...
                 $row[] = '<a class="delete" href="' . site_url('adm/campaign/delete/'.encode_url($aRow['campaign_id'])) . '" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>&nbsp;&nbsp;<a href="' . site_url('adm/campaign/unarchive/'.encode_url($aRow['campaign_id'])) . '" title="Unarchive"><i class="fa fa-archive" aria-hidden="true"></i></a>';
	...
	public function edit($id = NULL)
	{
        ...
        if($this->form_validation->run() == true){    
            ...
            redirect('adm/campaign');                     
        }           
		// Load the view	
		$this->template->load('admin','campaign/edit_campaign',$this->data);	
	}	
    ...
    public function archive($id  = NULL)
    {
        ...
        redirect('adm/campaign/archiveindex');      
    }
    /**
