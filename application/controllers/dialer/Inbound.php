...
class Inbound extends CI_Controller{
    ...
    public function groupindex(){
        ...
        $this->data['addactioncontroller'] = "dialer/inbound/groupedit";
        $this->template->load("admin","dialer/admin/inbound/group/list",$this->data);
    }
    public function groupindexjson(){
        ...
        if($rResult){
            foreach( $rResult as $aRow ){
                    ...
                    $row[] = '<a href="'.site_url('dialer/inbound/groupedit/'.encode_url($aRow['group_id'])).'"><i class="fa  fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a class="delete" href="'.site_url('dialer/inbound/groupdelete/'.encode_url($aRow['group_id'])).'"><i class="fa fa-trash" aria-hidden="true"></i></i>';
    ...
    public function groupedit($id = NULL){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            if($ingroupId){
                ...
                redirect(site_url('dialer/inbound/groupedit/'.encode_url($ingroupId)));
            }
        }
        $this->template->load('admin','dialer/admin/inbound/group/edit',$this->data);
    }
    public function groupdelete($id = NULL) {
        ...
        redirect('dialer/inbound/groupindex');
    }
    ...
    public function didindex(){
        ...
        $this->data['addactioncontroller'] = "dialer/inbound/didedit";
        $this->template->load("admin","dialer/admin/inbound/did/list",$this->data);
    }
    public function didindexjson(){
        ...
        if($rResult){
            foreach( $rResult as $aRow ){
                    ...
                    $row[] = '<a href="'.site_url('dialer/inbound/didedit/'.encode_url($aRow['did_id'])).'"><i class="fa  fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a class="delete" href="'.site_url('dialer/inbound/diddelete/'.encode_url($aRow['did_id'])).'"><i class="fa fa-trash" aria-hidden="true"></i></i>';
    ...
    public function didedit($id = NULL){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            if($did){
                ...
                $aData = array('vicidial_did_id' => $did, 'agency_id' => $this->input->post('agency_id'));
                $this->ainded_m->save($aData, $adidId);
                $this->session->set_flashdata('success','Inbound DID saved successfully');
                redirect('dialer/inbound/didedit/'.  encode_url($did));
            }
        }
        $this->template->load("admin","dialer/admin/inbound/did/edit",$this->data);
    }
    ...
    public function menuindex(){
        ...
        $this->data['addactioncontroller'] = "dialer/inbound/menuedit";
        $this->template->load("admin","dialer/admin/inbound/menu/list",$this->data);
    }
    public function menuindexjson(){
        ...
        if($rResult){
            foreach( $rResult as $aRow ){
                    ...
                    $row[] = '<a href="'.site_url('dialer/inbound/menuedit/'.encode_url($aRow['menu_id'])).'"><i class="fa  fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a class="delete" href="'.site_url('dialer/inbound/menudelete/'.encode_url($aRow['menu_id'])).'"><i class="fa fa-trash" aria-hidden="true"></i></i>';
    ...
    public function menuedit($id = NULL){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            if($menuID){
                ...
                redirect('dialer/inbound/menuedit/'.encode_url($menuID));
            }
        }
        $this->template->load("admin","dialer/admin/inbound/menu/edit", $this->data);
    }
    ...
    public function menudelete($id = NULL) {
        ...
        redirect('dialer/inbound/menuindex');
    }
    ...
    public function savemenuoption(){
        ...
        if($post){
            ...
            redirect(site_url('dialer/inbound/menuedit/'.encode_url($menu_id)));
        }
    }
}
