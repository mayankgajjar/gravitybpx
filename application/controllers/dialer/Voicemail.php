...
class Voicemail extends CI_Controller{
    ...
    public function index(){
        ...
        $this->template->load('admin', "dialer/admin/voicemail/list", $this->data);
    }
    public function indexjson(){
        $aColumns = array( 'voicemail_id' , 'fullname', 'active', 'messages', 'old_messages', 'delete_vm_after_email', 'user_group');
        /*
         * Paging
         */
        $sLimit = "";
        ...
        $rResult = $this->vvoicemail_m->query($sWhere, $sOrder, $sLimit);

        $aFilterResult = $this->vvoicemail_m->query($sWhere);
        if($aFilterResult){
            ...
            foreach( $rResult as $aRow )
                {
                    ...
                    for ( $i=0 ; $i<count($aColumns) ; $i++ )
                        ...
                        $row[] = '<a href="'.site_url('dialer/voicemail/edit/'.encode_url($aRow['voicemail_id'])).'"><i class="fa  fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a class="delete" href="'.site_url('dialer/voicemail/delete/'.encode_url($aRow['voicemail_id'])).'"><i class="fa fa-trash" aria-hidden="true"></i></i>';
    ...
    public function edit($id = NULL){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            if($voicemailId){
                ...
                redirect('dialer/voicemail/edit/'.  encode_url($voicemailId));
            }
        }
        $this->template->load('admin', "dialer/admin/voicemail/edit", $this->data);
    }
    ...
    public function delete($id = NULL){
        if($id){
                ...
                redirect('dialer/voicemail/index');
        }else{
    ...
    public function sound(){
        ...
        $this->load->view('dialer/admin/voicemail/sound',$this->data);
    }
