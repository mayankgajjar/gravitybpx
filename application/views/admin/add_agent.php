                    ...
                    <div class="tab-content">
							...
							<div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select name="agent_type" class="form-control">
                                        ...
                                        <option value='2'>Verification Agent</option>
                                        <option value='3'>Processing Agent</option>
                                    </select>
                        ...
                        <div class="tab-pane" id="tab2">
							...
							<div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control form-control-inline input-medium date-picker" name='dob' size="16" type="text" value=""/>
...
<script src="<?php echo site_url('assets/theam_assets/pages/scripts/form-wizard_agent.js'); ?>" type="text/javascript"></script>
