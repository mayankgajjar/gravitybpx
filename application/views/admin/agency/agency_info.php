...
<!-- BEGIN PAGE HEADER-->
    ...
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <h3 class="page-title"> Agency Information </h3>
    <!-- END PAGE TITLE-->
    <!-- END PAGE HEADER-->
					...
					<div class="tab-pane active" id="tab_1">
						<table class='table'>
							...
							<tr>
								...
								<td>
									<?php echo isset($agency->parent_name) ? chk($agency->parent_name): '&nbsp;' ?>
								</td>
							</tr>
							<tr>
								<td>
					...
					<div class="tab-pane" id="tab_2">
						<table class='table'>
							...
							<tr>
								...
								<td>
									<?php echo isset($agency->country) ? $agency->country:'&nbsp;'; ?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo isset($agency->state) ? $agency->state : ''; ?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo isset($agency->city)  ? $agency->city : ''; ?>
								</td>
							</tr>
							<tr>
								<td>
					...
					<div class="tab-pane" id="tab_3">
						<table class='table'>
							...
							<tr>
								...
								<td>
									<?php echo isset($agency->resident_state) ?  chk($agency->resident_state) : '' ?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<div class="scroller" data-rail-visible="1" data-rail-color="yellow" data-handle-color="#a1b2bd" style='height:100%'>
									<table class='table'>
										<tr>
											...
											<td style='width:60%'>
												<?php echo isset($agency->full_name) ? chk($agency->full_name) : ''; ?>
											</td>
										</tr>
										<tr>
											<td>
											...
											<td>
												<?php echo isset($agency->street_address) ? chk($agency->street_address):''; ?>
											</td>
										</tr>
										<tr>
											<td>
											...
											<td>
												<?php echo isset($agency->bank_country) ? chk($agency->bank_country):'' ?>
											</td>
										</tr>
										<tr>
											<td>
											...
											<td>
												<?php echo isset($agency->bank_state) ? chk($agency->bank_state):''; ?>
											</td>
										</tr>
										<tr>
											<td>
											...
											<td>
												<?php echo isset($agency->bank_city) ? chk($agency->bank_city):''; ?>
											</td>
										</tr>
										<tr>
											<td>
											...
											<td>
												<?php echo isset($agency->bank_zip_code) ? chk($agency->bank_zip_code) : ''; ?>
											</td>
										</tr>
										<tr>
											<td>
											...
											<td>
												<?php echo isset($agency->bank_routing_number) ? chk($agency->bank_routing_number):'' ?>
											</td>
										</tr>
										<tr>
											<td>
											...
											<td>
												<?php echo  isset($agency->bank_account_number) ? chk($agency->bank_account_number) :''; ?>
											</td>
										</tr>
									</table>
								</div>
