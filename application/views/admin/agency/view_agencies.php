...
<div class="portlet light bordered">
	<div class="portlet-title">
		...
		<div class="actions">
            <a class="btn btn-info" href="<?php echo site_url('admin/manage_agency/add'); ?>">
				...
				<?php
					foreach($agencies as $agency)
					{
						...
						<tr>
							...
							<td>
								<a class="info" title="Information" id="<?php echo $agency['id'] ?>" href="<?php echo site_url('admin/manage_agency/agency_info/'.$agency['id']); ?>">
									<span class="fa fa-info"></span>
								</a>&nbsp;&nbsp;
								<a href="<?php echo site_url('admin/manage_agency/edit/'.$agency['id']) ?>" style="text-decoration: none !important;">
									<i aria-hidden="true" class="fa  fa-pencil-square-o"></i>
								</a>&nbsp;&nbsp;
								<a class="delete" title="Delete" id="<?php echo $agency['id'] ?>" href="javascript:;">
									<span class="fa fa-trash"></span>
                                                                ...
                                                                <?php if($id > 0): ?>
                                                                    ...
                                                                    <?php if($user): ?>
                                                                        <a target="_blank" href="<?php echo site_url('dialer/users/edit/'.  encode_url($id)) ?>"><?php echo 'Dialer User' ?></a>
                                                                        <?php $phone = $this->aphones_m->get_by(array('vicidial_user_id' => $id), TRUE);?>
                                                                        <?php if(!$phone): ?>
                                                                            <a href="<?php echo site_url('dialer/phones/createphone/'.$id) ?>"><?php echo 'Create Phone' ?></a>
                                                                        <?php endif; ?>
                                                                    <?php else: ?>
                                                                        <a href="<?php echo site_url('dialer/users/createagency/'.$agency['id']) ?>"><?php echo 'Create Dialer User' ?></a>
                                                                    <?php endif; ?>
                                                                <?php else: ?>
                                                                    <a href="<?php echo site_url('dialer/users/createagency/'.$agency['id']) ?>"><?php echo 'Create Dialer User' ?></a>
                                                                <?php endif; ?>
...
<script type="text/javascript">
    $('document').ready(function(){
		...
		$('.delete').click(function(){
			...
			function(){
				var url = "<?php echo site_url('admin/manage_agency/delete/') ?>"+'/'+id;
				$.ajax({
					url : url,
