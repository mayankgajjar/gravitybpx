                ...
                <div class="form-body">
                    <ul class="nav nav-pills nav-justified steps">
                        <li>
                            <a href="#tab1" data-toggle="tab" class="step">
                                ...
                                <span class="desc">
                                    <i class="fa fa-check"></i><?php echo $agent->fname . ' ' . $agent->lname; ?> Account Details </span>
                            </a>
                        </li>
                        <li>
                            <a href="#tab2" data-toggle="tab" class="step">
                                ...
                                <span class="desc">
                                    <i class="fa fa-check"></i><?php echo $agent->fname . ' ' . $agent->lname; ?> Profile Details </span>
                            </a>
                        </li>
                        <li>
                            <a href="#tab3" data-toggle="tab" class="step active">
                                ...
                                <span class="desc">
                                    <i class="fa fa-check"></i><?php echo $agent->fname . ' ' . $agent->lname; ?> License Information</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab1">
                            <h3 class="block"><?php echo $agent->fname . ' ' . $agent->lname; ?> account details</h3>
                                ...
                                <div class="col-md-4">
                                    <select name="parent_agency" id="" class="form-control">
                                        ...
                                        foreach ($agencies as $value) {
                                            ?>
                                            <option value="<?php echo $value['id'] ?>" <?php echo $value['id'] == $agent->agency_id ? 'selected="selected"' : ''; ?>>
                                                <?php echo $value['name'] ?>
                                            </option>
                                            <?php
                                        }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select name="agent_type" class="form-control">
                                        <option value='1' <?php echo $agent->agent_type == '1' ? 'selected="selected"' : ''; ?>>Sales Agent</option>
                                        <option value='2' <?php echo $agent->agent_type == '2' ? 'selected="selected"' : ''; ?>>Verification Agent</option>
                                        <option value='3' <?php echo $agent->agent_type == '3' ? 'selected="selected"' : ''; ?>>Processing Agent</option>
                                    </select>
                        ...
                        <div class="tab-pane" id="tab2">
                            <h3 class="block"><?php echo $agent->fname . ' ' . $agent->lname; ?> profile details</h3>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" id='plivo_phone' class="form-control" name="plivo_phone" value="<?php echo $agent->plivo_phone; ?>"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control form-control-inline input-medium date-picker" name='dob' size="16" type="text" value="<?php echo $agent->date_of_birth; ?>"/>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3"><?php echo 'SIP Endpoint' ?></label>
                                <div class="col-md-4">
                                    <input type="text" disabled class="form-control" name="sip_end_point" value="<?php echo $agent->sip_end_point ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3"><?php echo 'SIP Endpoint Password' ?></label>
                                <div class="col-md-4">
                                    <input type="password" disabled class="form-control" name="sip_end_point_password" value="<?php echo $agent->sip_end_point_password ?>"/>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab3">
                            <h3 class="block"><?php echo $agent->fname . ' ' . $agent->lname; ?> license information</h3>
                            <div class="form-group">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="checkbox-list">
                                                <?php
                                                $non_resident_states = $agent->non_resident_state;
                                                $arr = array();
                                                foreach ($non_resident_states as $key => $value) {
                                                    $arr[] = $value[state_id];
                                                }
                                                foreach ($states as $state) {
                                                    ?>
...
<script type="text/javascript">
    $('document').ready(function () {
        ...
        $('[name="country"]').change(function () {
            var cid = $(this).val();
            $.ajax({
                url: 'Admin/manage_state/getByCountryId/' + cid + '/<?php echo $agent->state_id ?>',
                method: 'get',
                async: false,
        ...
        $('[name="state"]').change(function () {
            var sid = $(this).val();
            $.ajax({
                url: 'Admin/manage_city/getByStateId/' + '<?php echo $agent->state_id ?>' + '/<?php echo $agent->city_id ?>',
                method: 'get',
                async: false,
                success: function (str) {
                    $('#city_list').html(str);
