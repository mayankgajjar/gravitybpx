<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span><?php echo "Campaign Bids Type"; ?></span>
        </li>
    </ul>
    <div class="page-toolbar">
    </div>
</div>
<h3 class="page-title"><?php echo "Campaign Bids Type"; ?> </h3>
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption font-dark">
            <i class="fa fa-building-o font-dark"></i>
            <span class="caption-subject bold uppercase"> <?php echo "Campaign Bid Type Listing"; ?> </span>
        </div>
        <div class="actions">
            <a href="<?php echo site_url('adm/bid/edit'); ?>" class="btn btn-info">
                <i class="fa fa-plus"></i>
                <span class="hidden-xs"><?php echo "Add New Bid Type"; ?></span>
            </a>
            <!-- <a href="<?php echo site_url($importactioncontroller ); ?>" class="btn btn-info">
                <i class="fa fa-plus"></i>
                <span class="hidden-xs"><?php echo "Import New {$type}"; ?></span>
            </a>    -->         
        </div>
    </div>
    <div class="portlet-body">    
        <form class="categories_from" action="<?php echo site_url('adm/bid/massaction'); ?> " name="categories_form" method="post" onsubmit="submitform(event)">
...
<script type="text/javascript">
    jQuery(function(){
        ...
        jQuery('#datatable').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('adm/bid/indexjson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,4]
                },{
