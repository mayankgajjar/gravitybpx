...
<h3 class="page-title"><?php echo "Campaign Filter"; ?> </h3>
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption font-dark">
            <i class="fa fa-building-o font-dark"></i>
            <span class="caption-subject bold uppercase"> <?php echo "Campaign Filter Listing"; ?> </span>
        </div>
        <div class="actions">
            <a href="<?php echo site_url('adm/filter/edit'); ?>" class="btn btn-info">
                <i class="fa fa-plus"></i>
                <span class="hidden-xs"><?php echo "Add New Filter"; ?></span>
            </a>    
        </div>
    </div>
    <div class="portlet-body">    
        <form class="categories_from" action="<?php echo site_url('adm/filter/massaction'); ?> " name="categories_form" method="post" onsubmit="submitform(event)">
...
<script type="text/javascript">
    jQuery(function(){
        ...
        jQuery('#datatable').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('adm/filter/indexjson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,4]
                },{
