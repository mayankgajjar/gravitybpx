...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a href="<?php echo site_url($addactioncontroller ); ?>" class="btn btn-info">
                ...
                <span class="hidden-xs"><?php echo "Add New {$type}"; ?></span>
            </a>
    ...
    <div class="portlet-body">
        <form class="categories_from" action="<?php echo site_url('adm/lead/massaction/'. lcfirst($type)); ?> " name="categories_form" method="post" onsubmit="submitform(event)">
...
<script type="text/javascript">
    jQuery(function(){
        ...
        jQuery('#datatable').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('adm/lead/indexjson/'.$type); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,10]
                },{
