...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a href="<?php echo site_url('adm/email_template/edit'); ?>" class="btn btn-info">
                <i class="fa fa-plus"></i>
                <span class="hidden-xs"><?php echo "Add New Template"; ?></span>
            </a>       
        </div>
    </div>
    <div class="portlet-body">
        <form class="categories_from" id="quickform" action="<?php echo site_url('adm/email_template/massaction'); ?> " name="categories_form" method="post" onsubmit="javascript:submitform(event)">
...
<script type="text/javascript">
 jQuery(function(){
        ...
        jQuery('#datatable').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('adm/email_template/indexJson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,5]
                },{
