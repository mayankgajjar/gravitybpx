<div class="modal-header">
            ...
            <div class="modal-body">     
             <div class="row">       	
                ...
                <div class="col-md-12">    
                    <div class="radio-list modal_msg_field">
                        <label><input type="radio" name="optradio" value="{amount}">Amount</label>
                    </div>
                </div>
                <div class="col-md-12">    
                    <div class="radio-list modal_msg_field">
                        <label><input type="radio" name="optradio" value="{transaction}">Transaction Id</label>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="radio-list modal_msg_field">
                        <label><input type="radio" name="optradio" value="{companynamr}" />Company Name</label>
                    </div>
                </div>                
	          </div>   
            </div>
