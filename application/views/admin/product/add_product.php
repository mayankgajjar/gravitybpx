    ...
    <div class="portlet-body">
        <form class="form-horizontal form-row-seperated" action="<?php echo site_url('products/manage_products/add') ?>" enctype="multipart/form-data" name="product_form" method="post" id="product_form">
                <?php
                    ...
                    <?php if($pre_existing_conditions == "yes"): ?>
                    ...
                    <?php elseif ($pre_existing_conditions == "no") : ?>
                        <script type="text/javascript">
                            $('document').ready(function()
                            {
                ...
                <div class="form-group app_info_error">
                    ...
                    <div class="col-md-9">
                        ...
                        <input type="hidden" name="application_product_information" value="<?php echo isset($products->application_information) ? unserialize($products->application_information) : ''; ?>" class="" />
...
<script type="text/javascript">
    $('document').ready(function(){
        ...
        var edit_state = '<?php echo isset($products->id) ? $products->id : '' ?>';
        if(edit_state != "")
        {
            $('[name="product_country"]').trigger('change');
            var state_checked = '<?php echo isset($products->state_id) ? $products->state_id : '' ?>';
        ...
        var edit_company_id = "<?php echo isset($products->underwriting_company) ? $products->underwriting_company : '' ?>";
