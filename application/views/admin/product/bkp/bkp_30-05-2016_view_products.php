                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_products">
                    <thead>
                        <tr role="row" class="heading">
                            ...
                            <th width="5%" data-order="id"> ID </th>
                            <th width="15%" data-order="category_name"> Category </th>
                            <th width="15%" data-order="product_name"> Product Name </th>
                            <th width="15%" data-order="company_name"> Company </th>
                            <th width="15%" data-order="product_levels"> Product Levels </th>
                            <th width="20%" data-order="price"> Price </th>                        
                            <th width="15%" data-order="age"> Age </th>                        
                            <th width="15%" data-order="status"> Status </th>
