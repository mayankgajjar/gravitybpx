				...
				<?php
					foreach($agencies as $agency)
					{
						...
						<tr>
							...
							<td>
								<a class="info" title="Information" id="<?php echo $agency['id'] ?>" href="Admin/manage_agency/agency_info/<?php echo $agency['id'] ?>">
...
<script src="assets/theam_assets/pages/scripts/table-datatables-buttons.js" type="text/javascript"></script>
...
<script type="text/javascript">
    $('document').ready(function(){
		...
		$('.delete').click(function(){
			...
			function(){
				$.ajax({
					url : 'Admin/manage_agency/delete/'+id,
