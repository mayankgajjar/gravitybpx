...
<!-- BEGIN PAGE HEADER-->
    ...
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <h3 class="page-title"> Add Sub-Agency </h3>
    <!-- END PAGE TITLE-->
    <!-- END PAGE HEADER-->
<!-- BEGIN SAMPLE FORM PORTLET-->
                    ...
                    <div class="tab-content">
                                ...
                                <div class="col-md-5">
                                    <select name="parent_agency" id="" class="form-control">
                                        <option value="0">No Parent Agency</option>
                                                <option  value="<?php echo $parentAgency->id ?>" selected="selected">
                                                    <?php echo $parentAgency->name ?>
                                                </option>
                                    </select>
                        ...
                        <div class="tab-pane" id="tab2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" class="form-control" name="mname" placeholder="" value="<?php echo isset($agency->mname) ? $agency->mname : ''; ?>"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" class="form-control mask_phone fax" id='fax' name="fax" value="<?php echo $agency->fax_number ?>" />
                                ...
                                <div id="responsive" class="modal fade" style='left:40%;width:60%;' tabindex="-1" data-width="760">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <?php
                                                $arr = array();
                                                if(isset($agency->non_resident_state)){
                            ...
                            <div id='bank_container' class='show_up'>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if($agency->id != '') { ?>
                                        ...
                                        <?php $states = $this->State_model->getCountryByStateId(isset($city->state_id) ? $city->state_id : '') ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <?php $cities = $this->City_model->getCityByStateId(isset($city->state_id) ? $city->state_id : ''); ?>
                                        <select name="bank_city" id="bank_city_list" class="form-control">
                                            <option value="">Select City</option>
                                            <?php foreach($cities as $c): ?>
                                              <option value="<?php echo $c['id']; ?>" <?php echo isset($agency->bank_city_id) && $c['id'] == $agency->bank_city_id ? 'selected=""selected':'' ?>><?php echo $c['name'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4">Bank Routing Number
                                        <span class="required"> * </span>
                                    </label>
                                    <div class="col-md-5">
                                            ...
                                            <select class='form-control' name='card_type' value="<?php echo set_value('card_type'); ?>">
                                                ...
                                                <?php
                                                    if(!empty($card_type))
                                                    {
                                                        ...
                                                        {
                                                        ?>
                                                            <option <?php if($agency->card_type == $key){ echo "selected "; } ?> value="<?php echo $key; ?>"><?php echo $value; ?></option>
                                                        <?php
                                                        }
                                                    }
                                                ?>
...
<script type="text/javascript">
    $('document').ready(function(){
        ...
        /*$('[name="country"]').change(function(){
            var cid = $(this).val();
            <?php if($agency->id != ''): ?>
                var $url = 'agency/manage_state/getByCountryId/'+cid+'/<?php echo $agency->state_id ?>';
            <?php else: ?>
                var $url = 'agency/manage_state/getByCountryId/'+cid;
            <?php endif; ?>
            $.ajax({
                url : $url,
                method : 'get',
        ...
        $('[name="state"]').change(function(){
            var sid = $(this).val();
            <?php if($agency->id != ''): ?>
                var $url = 'agency/manage_city/getByStateId/'+sid+'/<?php echo $agency->city_id ?>';
            <?php else: ?>
                var $url ='agency/manage_city/getByStateId/'+sid;
            <?php endif; ?>
            $.ajax({
                url : $url,
                method : 'get',
        ...
        <?php if( $agency->id  != '') :?>
            ...
            var bank_city_id = "<?php echo isset($agency->bank_city_id) ? $agency->bank_city_id :'' ?>";
            if(bank_city_id != "")
            {
