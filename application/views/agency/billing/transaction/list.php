...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a href="<?php echo site_url('age/billing/exporttransaction') ?>" class="btn green"><span>Export To CSV</span></a>
        </div>
    </div>   
...
<script type="text/javascript">
    jQuery(function(){
        ...
        jQuery('#datatable').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('age/billing/transactionjson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0, 8]
                },{
...
function doRefund(tranId){
    var surl = '<?php echo site_url("age/billing/refund") ?>'+'/'+tranId;
