...
<h3 class="page-title"><?php echo "Archive Campaign"; ?> </h3>
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption font-dark">
            <i class="fa fa-building-o font-dark"></i>
            <span class="caption-subject bold uppercase"> <?php echo "Archive Campaign Listing"; ?> </span>
        </div>
        <div class="actions">
            <!-- <a href="<?php echo site_url('age/campaign/edit'); ?>" class="btn btn-info">
    ...
    <div class="portlet-body">    
        <form class="categories_from" action="<?php echo site_url('age/campaign/massaction'); ?> " name="categories_form" method="post" onsubmit="submitform(event)">
...
<script type="text/javascript">
    jQuery(function(){
        ...
        jQuery('.archive-campaign').addClass('active');        
        jQuery('#datatable').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('age/campaign/archiveindexjson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,9]
                },{
