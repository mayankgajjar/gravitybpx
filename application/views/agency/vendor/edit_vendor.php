        ...
        <form class="form-horizontal" action="" id="vendor_form" method="POST">
            <div class="form-body">
                    ...
                    <div class="col-md-4 "> 
                        <select name="agent_id" class="form-control">
                            ...
                            <?php if(count($buyers) > 0) :?>   
                                ...
                                <option value="<?php echo $buyer->id ?>" <?php echo $vendor->agent_id == $buyer->id ? 'selected="selected"':'' ?> ><?php echo $buyer->fname.' '.$buyer->lname; ?></option>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="email_id" id="emailid" value="<?php echo $vendor->email_id; ?>" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input class="form-control form-control-inline input-medium date-picker" name='date_of_birth' size="16" type="text" value="<?php if($vendor->date_of_birth != '') { echo date("m/d/Y",strtotime($vendor->date_of_birth)); } ?>"/>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <a class="btn" href="<?=base_url('age/vendor')?>">Cancel</a>
                    </div>
                </div>
            </div>        
        </form>
...
$('document').ready(function(){		
        ...
        $('[name="country_id"]').change(function(){
            var cid = $(this).val();
            $.ajax({
                url : 'age/vendor/manage_state/getByCountryId/'+cid+'/<?php echo $vendor->state_id ?>',
                method : 'get',
                async : false,
        ...
        $('[name="state_id"]').change(function(){
            var sid = $(this).val();
            $.ajax({
                url : 'age/vendor/manage_city/getByStateId/'+sid+'/<?php echo $vendor->city_id ?>',
                method : 'get',
                async : false,
                success : function(str){
                    $('#city_list').html(str);
