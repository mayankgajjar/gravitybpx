...
<?php //pr($this->session->userdata("user")); ?>
<?php //pr($this->session->userdata('agent')->id); ?>
    ...
    <div class="portlet-body">
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <input type="text" name="last_name" placeholder="Last Name" class="form-control" value="<?php echo set_value('last_name'); ?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3  control-label"><?php echo 'Email' ?></label>
                    <div class="col-md-4">
                        <input type="text" name="email" class="form-control" id ="emailid" value="<?php echo $lead->email ?>" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="phone" class="form-control" id="phone-number" value="<?php echo $lead->phone ?>"/>
                    </div>
                </div>
                <div class="form-group">
        ...
        jQuery('#leadForm').validate({
            ...
            rules: {
                ...
                phone:{
                    ...
                    minlength: 10,
                    remote: {
                        url: "<?php echo site_url('ajax/checkPhone') ?>",
                        type: "post",
                        data: {
                        phone : function() {
        ...
        /*$( "#emailid" ).change(function() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('.email-msg').show();
                    if(data == 'false'){
                        $('.email-msg').html('Email address is already exist, please try other email address');
                        $('.email-msg').css("color", "#e73d4a");
                        $('#emailid').focus();
                    } else {
                        $('.email-msg').html('Email address is valid');
                    }
                },
            });
            ...
            if(numbersize == 10){
                $.ajax({
                    ...
                    success: function (data) {
                        $('.phone-msg').show();
                        if(data == 'false'){
                            $('.phone-msg').html('Phone number is already exist, please try other number.');
                            $('.phone-msg').css("color", "#e73d4a");
                            $('#phone-number').focus();
                        } else {
                            $('.phone-msg').html('Phone number is valid');
                        }
                    },
                });
            } else {
