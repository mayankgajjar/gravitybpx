...
<div class="modal-dialog modal-lg nipl-lead-model">
    <form action="" method="post" id="client-form" onsubmit="return getdata(this, event)">
        <div class="modal-content">
            ...
            <input type="hidden" name="type" value="client" class="type">
