...
<div class="modal-dialog modal-lg nipl-lead-model">
    <form action="" method="post" id="opportunity-form"  onsubmit="return getdata(this,event)">
        <div class="modal-content">
            ...
            <input type="hidden" name="type" value="opportunity" class="type">
...
<script>
    ...
    jQuery('#opportunity-form').validate({
