            ...
            $('#form_wizard_1').bootstrapWizard({
                ...
                onNext: function (tab, navigation, index) {
                    ...
                    if(index == 1){
                       ...
                       jQuery.ajax({
                         url : '<?php echo site_url("leadstore/checkvertical") ?>',
                         method : 'POST',   
                         dataType : 'json',                         
...
function emailTest()
{
    ...
    jQuery.ajax({
        url : '<?php echo site_url("leadstore/testemail") ?>',
        method : 'POST',
        dataType : 'json',
