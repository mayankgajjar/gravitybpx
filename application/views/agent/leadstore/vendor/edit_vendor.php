            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <a class="btn" href="<?=base_url('vendor')?>">Cancel</a>
                    </div>
                </div>
            </div>        
        </form>
...
$('document').ready(function(){		
        ...
        $('[name="country_id"]').change(function(){
            var cid = $(this).val();
            $.ajax({
                url : 'Vendor/manage_state/getByCountryId/'+cid+'/<?php echo $vendor->state_id ?>',
                method : 'get',
                async : false,
        ...
        $('[name="state_id"]').change(function(){
            var sid = $(this).val();
            $.ajax({
                url : 'Vendor/manage_city/getByStateId/'+sid+'/<?php echo $vendor->city_id ?>',
                method : 'get',
                async : false,
                success : function(str){
                    $('#city_list').html(str);
