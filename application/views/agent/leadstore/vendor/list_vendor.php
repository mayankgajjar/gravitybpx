...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a href="<?php echo site_url('vendor/edit'); ?>" class="btn btn-info">
    ...
    <div class="portlet-body">
        <form class="categories_from" id="quickform" action="<?php echo site_url('vendor/massaction'); ?> " name="categories_form" method="post" onsubmit="javascript:submitform(event)">
...
<script type="text/javascript">
 jQuery(function(){
        ...
        jQuery('#datatable').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('vendor/vendorjson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,4]
                },{
