...
<div class="portlet light bordered">
    ...
    <div class="portlet-body">
        <form method="post" name="massaction" action="<?php echo site_url('dialer/calltime/statecalltimemassaction'); ?>">
    ...
    <script type="text/javascript">
        jQuery(function(){
            jQuery('#datatable').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('dialer/calltime/stateindexJson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,6]
                },{
