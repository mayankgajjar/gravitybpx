                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <select name="lead_order" class="form-control">
            				<option value='DOWN' selected="" ><?php echo "DOWN" ?></option>
            				<option value='UP'><?php echo "UP" ?></option>
            				<option value='DOWN PHONE'><?php echo "DOWN PHONE" ?></option>
            				<option value='UP PHONE'><?php echo "UP PHONE" ?></option>
            				<option value='DOWN LAST NAME'><?php echo "DOWN LAST NAME" ?></option>
            				<option value='UP LAST NAME'><?php echo "UP LAST NAME" ?></option>
            				<option value='DOWN COUNT'><?php echo "DOWN COUNT" ?></option>
            				<option value='UP COUNT'><?php echo "UP COUNT" ?></option>
            				<option value='RANDOM'><?php echo "RANDOM" ?></option>
            				<option value='DOWN LAST CALL TIME'><?php echo "DOWN LAST CALL TIME" ?></option>
            				<option value='UP LAST CALL TIME'><?php echo "UP LAST CALL TIME" ?></option>
            				<option value='DOWN RANK'><?php echo "DOWN RANK" ?></option>
            				<option value='UP RANK'><?php echo "UP RANK" ?></option>
            				<option value='DOWN OWNER'><?php echo "DOWN OWNER" ?></option>
            				<option value='UP OWNER'><?php echo "UP OWNER" ?></option>
            				<option value='DOWN TIMEZONE'><?php echo "DOWN TIMEZONE" ?></option>
                            ...
                            <option value='DOWN TIMEZONE 6th NEW'>UP TIMEZONE 2nd NEW</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <select class="form-control" name="use_internal_dnc">
                            ...
                            <option value="N" selected="" <?php echo optionSetValue($campaign->use_internal_dnc,'N') ?>><?php echo 'No' ?></option>
                        </select>
                    </div>
                </div>
            </div>
