...
<div class="portlet light bordered">
    ...
    <div class="portlet-body">
        <form class="categories_from" action="<?php echo site_url('dialer/campaign/campaignmassaction'); ?> " name="categories_form" method="post">
            <?php
...
<script type="text/javascript">
    $('document').ready(function(){
        jQuery('#datatable').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('dialer/campaign/indexJson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,3,5]
                },{
