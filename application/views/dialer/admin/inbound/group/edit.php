        ...
        <form id="groupForm" name="groupForm" id="groupForm" action="" method="post" class="form-horizontal" >
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <select class="form-control" name="user_group" id="user_group">
                            <option value="---ALL---"><?php echo 'All Admin User Groups' ?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <a href="<?php echo site_url('dialer/ajax/getvoicemaillist/voicemail_ext') ?>" data-target="#ajax" data-toggle="modal"><?php echo 'voicemail chooser' ?></a>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <a href="<?php echo site_url('dialer/ajax/getvoicemaillist/after_hours_voicemail') ?>" data-target="#ajax" data-toggle="modal"><?php echo 'voicemail chooser' ?></a>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <a href="<?php echo site_url('dialer/ajax/sound/after_hours_message_filename') ?>" data-target="#ajax" data-toggle="modal"><?php echo 'audio chooser' ?></a>
                    </div>
                </div>
                <div class="form-group">
				...
				<?php $no_agent_action_value = 'SALESLINE,CID,LB,998,TESTCAMP,1'; ?>
                    ...
                    <?php if($ingroup->no_agent_action == 'MESSAGE' ): ?>
                        ...
                        <div class="col-md-2">
                            <a href="<?php echo site_url('dialer/ajax/sound/no_agent_action_value') ?>" data-target="#ajax" data-toggle="modal"><?php echo 'audio chooser' ?></a>
                        </div>
                    ...
                    <?php if(($no_agent_action=='VOICEMAIL') or  ($no_agent_action=='VMAIL_NO_INST')): ?>
                        ...
                        <div class="col-md-2">
                            <a href="<?php echo site_url('dialer/ajax/getvoicemaillist/no_agent_action_value') ?>" data-target="#ajax" data-toggle="modal"><?php echo 'voicemail chooser' ?></a>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <a href="<?php echo site_url('dialer/ajax/sound/welcome_message_filename') ?>" data-target="#ajax" data-toggle="modal"><?php echo 'audio chooser' ?></a>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <a href="<?php echo site_url('dialer/ajax/sound/onhold_prompt_filename') ?>" data-target="#ajax" data-toggle="modal"><?php echo 'audio chooser' ?></a>
                    </div>
                </div>
                <div class="form-group">
