...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a class="btn btn-info" href="<?php echo site_url('dialer/statuses/edit'); ?>">
                <i class="fa fa-plus"></i>
                <span class="hidden-xs"><?php echo 'Add New Status' ?></span>
            </a>
        </div>
    </div>
    <div class="portlet-body">
        <form method="post" name="massaction" action="<?php echo site_url('dialer/statuses/massaction'); ?>">
        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="datatable">
            <thead>
                <tr>
                    ...
                    <th><?php echo "Transfer To CRM" ?></th>
                    <th><?php echo "Min Sec"; ?></th>
                    <th><?php echo "Max Sec"; ?></th>
                    <th>&nbsp;</th>
                </tr>
            </thead>
            <tbody>
    ...
    <script type="text/javascript">
        jQuery(function(){
            jQuery('#datatable').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('dialer/statuses/indexjson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,7]
                },{
