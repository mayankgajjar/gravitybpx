                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="agency_id" class="form-control" class="agency_id">
                            <option value="<?php echo $this->session->userdata('agency')->id; ?>">&nbsp;&nbsp;</option>
                            <?php echo printTree($tree,0, null, $campaign->agency_id ); ?>
                        </select>
                        <span class="help-block"> <?php echo 'Select blank for current loged in agency.' ?>  </span>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-3 col-md-9">
                        ...
                        <button class="btn btn-circle grey-salsa btn-outline" type="button" onclick="location.href='<?php site_url('dialer/acampaign/index') ?>'">Cancel</button>
                    </div>
                </div>
            </div>
        </form>
