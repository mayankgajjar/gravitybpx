                        ...
                        <?php foreach ($statuses as $status): ?>
                            <tr id="status-<?php echo $status->status ?>">
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="model" value="<?php echo 'vcstatuses_m'; ?>" />
                                ...
                                <td>
                                    <select name="category" class="form-control">
                                        ...
                                        <?php foreach($categories as $category): ?>
                                            <option value="<?php echo $category->vsc_id; ?>" <?php echo optionSetValue($category->vsc_id, $status->category) ?>><?php echo $category->vsc_id; ?></option>
                                         <?php endforeach; ?>
                                    </select>
                                </td>
                                <td>
                         ...
                         <div class="form-body">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-4">
                                     <select name="human_answered" id="human_answered" class="form-control">
                                         <option value="<?php echo "Y"; ?>"><?php echo "Yes"; ?></option>
                                         <option value="<?php echo "N"; ?>" selected=""><?php echo "No"; ?></option>
                                     </select>
                                 </div>
                             </div>
                             <div class="form-group">
...
//        });
    ...
    function edit(status)
    {
        ...
        jQuery.ajax({
            url: '<?php echo site_url('dialer/acampaign/ajaxedit/') ?>',
            dataType: 'JSON',
            data : obj,
            method: 'POST',
            success: function(result){
                ...
                if( flag == true ){
                    ...
                    location.href = '<?php echo site_url("dialer/acampaign/statusedit/".  encode_url($campaign->campaign_id))  ?>';
                }else{
    ...
    function deleteAll(status)
    {
        ...
        jQuery.ajax({
            url: '<?php echo site_url('dialer/acampaign/deleteall') ?>',
            dataType: 'JSON',
            data : obj,
            method: 'POST',
            success: function(result){
