...
<ul class="nav nav-tabs ">
    <li id="campaignedit">
        <a href="<?php echo site_url('dialer/acampaign/campaignedit/'. encode_url($campaign->campaign_id)) ?>"> <?php echo "Campaign View" ?> </a>
    </li>
<!--    <li id="campaigndetail">
    ...
    <li id="statusedit">
        <a href="<?php echo site_url('dialer/acampaign/statusedit/'.encode_url($campaign->campaign_id)) ?>"><?php echo "Statuses" ?> </a>
    </li>
<!--    <li id="hotkeyedit">
...
<!--    <li id="leadedit">
    ...
    <li id="autoaltedit">
        <a href="<?php echo site_url('dialer/acampaign/autoaltedit/'.  encode_url($campaign->campaign_id)); ?>"> <?php echo 'Auto Alt Dial'; ?> </a>
    </li>
<!--<li id="listmixedit">
