...
<div class="portlet light bordered">
    ...
    <div class="portlet-body">
        <form method="post" name="massaction" action="<?php echo site_url('dialer/afilter/massaction'); ?>">
        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="datatable">
            <thead>
                <tr>
                    ...
                    <th><?php echo "Filter Id"; ?></th>
                    <th><?php echo "Filter Name"; ?></th>
    ...
    <script type="text/javascript">
        jQuery(function(){
            jQuery('#datatable').dataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('dialer/afilter/indexjson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,4,5]
                },{
