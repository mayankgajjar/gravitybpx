...
<div class="portlet light bordered">
    ...
    <div class="portlet-body">
        <form method="post" name="massaction" action="<?php echo site_url('dialer/agroup/massaction'); ?>">
        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="datatable">
            <thead>
                <tr>
                    ...
                    <th><?php echo "Force Timelock"; ?></th>
                    <th><?php echo "Crated By" ?></th>
                    <th>&nbsp;</th>
                </tr>
            </thead>
            <tbody>
    ...
    <script type="text/javascript">
        jQuery(function(){
            jQuery('#datatable').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('dialer/agroup/indexjson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,5]
                },{
