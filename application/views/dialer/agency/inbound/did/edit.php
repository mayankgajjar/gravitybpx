...
jQuery(function(){
    ...
    selectUserIngroup('<?php echo isset($did->agency_id) && strlen($did->agency_id) > 0  ? $did->agency_id : $this->session->userdata('agency')->id ?>','<?php echo $did->group_id ?>');
    selectRouteIngroup('<?php echo isset($did->agency_id) && strlen($did->agency_id) > 0  ? $did->agency_id : $this->session->userdata('agency')->id ?>','<?php echo $did->user_route_settings_ingroup ?>');
    selectCallmenu('<?php echo isset($did->agency_id) && strlen($did->agency_id) > 0  ? $did->agency_id : $this->session->userdata('agency')->id ?>', '<?php echo $did->menu_id ?>');
