    ...
    <div class="portlet-title">
        ...
        <div class="actions">
            <a href="<?php echo site_url($addactioncontroller ); ?>" class="btn btn-info">
                ...
                <span class="hidden-xs"><?php echo "Add A New In-Group"; ?></span>
            </a>
        </div>
    </div>
    <div class="portlet-body">
        <form method="post" name="massaction" action="<?php echo site_url('dialer/ainbound/groupmassaction'); ?>">
    ...
    <script type="text/javascript">
        jQuery(function(){
            ...
            jQuery('#datatable').dataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('dialer/ainbound/groupindexjson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,9]
                },{
