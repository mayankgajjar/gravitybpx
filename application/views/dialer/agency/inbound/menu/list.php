    ...
    <div class="portlet-title">
        ...
        <div class="actions">
            <a href="<?php echo site_url($addactioncontroller ); ?>" class="btn btn-info">
                ...
                <span class="hidden-xs"><?php echo "Add A Call Menu"; ?></span>
            </a>
        </div>
    </div>
    <div class="portlet-body">
        <form method="post" name="massaction" action="<?php echo site_url('dialer/ainbound/menumassaction'); ?>">
    ...
    <script type="text/javascript">
        jQuery(function(){
            ...
            jQuery('#datatable').dataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('dialer/ainbound/menuindexjson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,5,6,7,8]
                },{
