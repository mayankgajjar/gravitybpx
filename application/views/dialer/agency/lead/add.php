                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <span class="help-content"> Leave blank for current log in agency.</span>
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    function selectCity(state,city_name){
        ...
        jQuery.ajax({
            url : '<?php echo site_url('dialer/alists/getcity') ?>',
            method : 'post',
            dataType : 'json',
    ...
    function selectList(agency_id, list_id){
        jQuery.ajax({
            url : '<?php echo site_url('dialer/alists/getlist') ?>',
            method : 'post',
            dataType : 'json',
    ...
    jQuery(function(){
        selectList('<?php echo isset($alead->agency_id) ? $alead->agency_id : $this->session->userdata('agency')->id ?>','<?php echo isset($alead->list_id) ? $alead->list_id : '' ?> ');
