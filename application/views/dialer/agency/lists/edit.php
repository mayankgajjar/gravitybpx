                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="agency_id" class="form-control" class="agency_id" onchange="javascript:selectCampaign(this.value)">
                            ...
                            <?php echo printTree($tree,0, null, isset($alist->agency_id) ? $alist->agency_id : ''  ); ?>
                        </select>
                        <span class="help-content"> <?php echo "Leave blank for current log in agency."; ?></span>
                    </div>
                </div>
                <div class="form-group">
...
<!--                <div class="form-group">
        ...
        <script type="text/javascript">
            function selectCampaign(value){
               jQuery.ajax({
                   url : '<?php echo site_url('dialer/alists/getCampaigns/') ?>',
                   method : 'POST',
                   dataType : 'json',
            ...
            jQuery(function(){
                ...
                <?php else: ?>
                     selectCampaign('<?php echo $this->session->userdata('agency')->id ?>');
