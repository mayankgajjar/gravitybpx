...
<div class="portlet light bordered">
    ...
    <div class="portlet-body">
        <form class="categories_from" action="<?php echo site_url('dialer/alists/massaction'); ?> " name="categories_form" method="post">
...
<script type="text/javascript">
    jQuery(function(){
        jQuery('#datatable').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('dialer/alists/indexJson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,4,5,10,11]
                },{
