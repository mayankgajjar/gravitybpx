                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="agency_id" class="form-control" class="agency_id" onchange="javascript:selectUsers(this.value)">
                            ...
                            <option value="<?php echo encode_url($this->session->userdata('agency')->id) ?>" <?php echo optionSetValue($this->session->userdata('agency')->id, $ragent->agency_id) ?>><?php echo '' ?></option>
