...
<div class="portlet light bordered">
    ...
    <div class="actions">
            <a class="btn btn-info" href="<?php echo site_url('dialer/aremote/groupedit'); ?>">
    ...
    <div class="portlet-body">
        <form method="post" name="massaction" action="<?php echo site_url('dialer/aremote/groupmassaction'); ?>">
    ...
    <script type="text/javascript">
        jQuery(function(){
            jQuery('#datatable').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('dialer/aremote/groupindexjson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,9]
                },{
