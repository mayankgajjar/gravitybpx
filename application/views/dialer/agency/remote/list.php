...
<div class="portlet light bordered">
    ...
    <div class="actions">
            <a class="btn btn-info" href="<?php echo site_url('dialer/aremote/edit'); ?>">
                <i class="fa fa-plus"></i>
                <span class="hidden-xs"><?php echo 'Add New Remote Agent' ?></span>
            </a>
        </div>
    </div>
    <div class="portlet-body">
        <form method="post" name="massaction" action="<?php echo site_url('dialer/aremote/massaction'); ?>">
        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="datatable">
            <thead>
                <tr>
                    ...
                    <th><?php echo "User"; ?></th>
                    <th><?php echo "Lines"; ?></th>
                    <th><?php echo "Server"; ?></th>
                    <th><?php echo "Conf-Exten"; ?></th>
    ...
    <script type="text/javascript">
        jQuery(function(){
            jQuery('#datatable').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('dialer/aremote/indexjson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,9]
                },{
