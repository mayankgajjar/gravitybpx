            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="datatable">
                ...
                <tbody>
                    <?php foreach($agents as $agent): ?>
                        <tr>
                            <?php $dialerUser = $this->vusers_m->get_by(array('user_id' => $agent['vicidial_user_id']),TRUE); ?>
                            <td><a href="<?php echo site_url('agency/manage_agent/agent_info/'.$agent['id']) ?>"><?php echo $agent['fname'].' '.$agent['lname'] ?></a></td>
                            <td>
                                <?php if($dialerUser): ?>
                            ...
                            <td>
                                <?php if($dialerUser): ?>
                                    <a class="info" title="Edit" style="text-decoration:none;" id="<?php echo encode_url($dialerUser->user_id) ?>" href="<?php echo site_url('dialer/ausers/agentedit/'.encode_url($dialerUser->user_id).'/'.encode_url($agent['agency_id'])) ?>">
...
<!--                                    <a class="delete" title="Delete" id="<?php echo encode_url($agency['id']) ?>" href="javascript:;">
                                ...
                                <?php else: ?>
                                    <a class="info" title="<?php echo 'Create Dialer User' ?>" href="<?php echo site_url('dialer/ausers/createagent/'.  encode_url($agent['id'])) ?>"><?php echo "Create Dialer User" ?></a>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php  endforeach; ?>
