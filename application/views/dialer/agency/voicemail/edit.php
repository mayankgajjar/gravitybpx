        ...
        <form id="groupForm" name="groupForm" id="groupForm" action="" method="post" class="form-horizontal" >
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="agency_id"  class="form-control" class="agency_id" onchange="javascript:selectGroup(this.value)">
                            <option value="<?php echo $this->session->userdata('agency')->id ?>"><?php echo ""; ?></option>
                            <?php echo printTree($tree,0, null, $voicemail->agency_id ); ?>
                        </select>
                        <p class="help-content"><?php echo 'Leave blank for current agency.' ?></p>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-ms-2">
                        <a href="<?php echo site_url('dialer/avoicemail/sound') ?>" data-toggle="modal" data-target="#ajax"><?php echo 'Audio Chooser' ?></a>
                    </div>
                </div>
                <div class="form-group">
...
jQuery(function(){
    <?php if(strlen($voicemail->voicemail_id) > 1): ?>
            selectGroup('<?php echo $voicemail->agency_id ?>','<?php echo $voicemail->user_group ?>');
    <?php endif; ?>
...
function selectGroup(agency_id, groupId){
               ...
               jQuery.ajax({
                   url : '<?php echo site_url('dialer/avoicemail/getAgencyGroup/') ?>',
                   method : 'POST',
                   dataType : 'json',
