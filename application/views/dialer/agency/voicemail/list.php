...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a href="<?php echo site_url('dialer/avoicemail/edit'); ?>" class="btn btn-info">
                <i class="fa fa-plus"></i>
                <span class="hidden-xs"><?php echo  "Add Voicemail" ?></span>
            </a>
        </div>
    </div>
    <div class="portlet-body">
        <form method="post" name="massaction" action="<?php echo site_url('dialer/avoicemail/massaction'); ?>">
        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="datatable">
            <thead>
                <tr>
                    ...
                    <th><?php echo "Voicemail ID"; ?></th>
                    <th><?php echo "Name"; ?></th>
                    <th><?php echo "Active"; ?></th>
                    <th><?php echo "New Messages"; ?></th>
                    <th><?php echo "Old Messages"; ?></th>
    ...
    <script type="text/javascript">
        jQuery(function(){
            jQuery('#datatable').dataTable({
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url('dialer/avoicemail/indexjson'); ?>",
                "columnDefs": [ {
                    'orderable': false,
                    'targets': [0,9]
                },{
