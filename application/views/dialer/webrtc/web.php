<div class="dialer">
    ...
    <div class="main_menu-phone-icon" style="display:block">
        <div class="menu-phone-icon">
            <a id="menu-phone-icon"><i class="fa fa-th fa-2" aria-hidden="true"></i></a>
        </div>
    </div>
    <div id="btn_phone" class="btn_phone" style="display: none">
        <div id="btn-container">
            ...
            <div class="phone_dialer">
                ...
                <div class="countdownright">
                    ...
                    <div class="outbound">
                        <a href="javascript:void(0)" id="record" class="btn btn-info" onclick="recordAction('START')"><div class="main-btn btn-danger"><i class="fa fa-play-circle"></i></div> <!--span class="phone_char">Record</span--><span class="phone_char" id="time"></span></a>
                        ...
                        <div class="transfer_call btn green">
                            <a href="javascript:;" id="transfer_call" class="btn" data-click="0" onclick="transferAction();">
                                <i class="fa fa-phone icon-small"></i>
                                <i class="fa fa-phone icon-large"></i>
                                <span class="transfer_call_char">Transfer Call</span>
                            </a>
                        </div>
                    </div>
                </div><!-- .countdownright -->
        ...
        <div id="btn-container" class="lead-form">
            <div class="phone_dialer">
                <form class="form-horizontal" method="post" onsubmit="return false;" name="leadform">
                    <input type="hidden" name="lead_id" />
                    <input type="hidden" name="list_id" />
                    <input type="hidden" name="called_count" />
                    <input type="hidden" name="phoone_code" value="1" />
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="col-md-3"><?php echo "Phone Number" ?></label>
                            <div class="col-md-9">
                                <input type="text" name="phone_number" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3"><?php echo "First Name" ?></label>
                            <div class="col-md-9">
                                <input type="text" name="first_name" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3"><?php echo "Last Name" ?></label>
                            <div class="col-md-9">
                                <input type="text" name="last_name" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3"><?php echo "Email" ?></label>
                            <div class="col-md-9">
                                <input type="text" name="email" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3"><?php echo "Address" ?></label>
                            <div class="col-md-9">
                                <textarea name="address1" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2"><?php echo "Postal Code" ?></label>
                            <div class="col-md-3">
            ...
            switch (e.type) {
                ...
                case 'm_permission_refused':
                {
                    ...
                    if (e.type == 'm_permission_refused') {
                        ...
                        Command: toastr['info']("<i>" + s_description + "</i>");
                    }
                    break;
                }
                case 'starting':
    ...
    //Fucntion to send DTMF frames
        function sipSendDTMF(c) {
            if (mycallSession && c) {
                if (mycallSession.dtmf(c) == 0) {
                    var lastn = jQuery("#callnumber").val();
        ...
        function recordAction(action) {
            ...
            if (action == 'START') {
                ...
                jQuery('#record .main-btn i').attr('class', 'fa fa-pause');
                ...
                jQuery('#record .main-btn i').attr('class', 'fa fa-play');
