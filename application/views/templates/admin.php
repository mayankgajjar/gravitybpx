...
<html lang="en">
    ...
    <head>
        ...
        <?php endif; ?>
        <?php /*if( isset($model) && $model == TRUE ) : ?>
            <link href="<?php echo $this->config->item('base_url') ?>assets/theam_assets/global/plugins/bootstrap-modal/css/bootstrap-modal.css" rel="stylesheet" type="text/css" />
            <?php if( isset($modelManager) && $modelManager == TRUE ) : ?>
                 <link href="<?php echo $this->config->item('base_url') ?>assets/theam_assets/global/plugins/bootstrap-modal/css/bootstrap-modal-bs3patch.css" rel="stylesheet" type="text/css" />
            <?php endif; ?>
        <?php endif;*/ ?>
        ...
        <?php endif; ?>
        <?php /*if( isset($model) && $model == TRUE ) : ?>
            <script src="<?php echo $this->config->item('base_url') ?>assets/theam_assets/global/plugins/bootstrap-modal/js/bootstrap-modalmanager.js" type="text/javascript"></script>
            <script src="<?php echo $this->config->item('base_url') ?>assets/theam_assets/global/plugins/bootstrap-modal/js/bootstrap-modal.js" type="text/javascript"></script>
        <?php endif;*/ ?>
        <?php if(isset($colorpicker) && $colorpicker == TRUE): ?>
        ...
        <?php endif; ?>
        <?php if(isset($fileinput) && $fileinput == TRUE): ?>
                            ...
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="assets/theam_assets/layouts/layout/img/avatar3.jpg" alt="...">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="assets/theam_assets/layouts/layout/img/avatar1.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="assets/theam_assets/layouts/layout/img/avatar4.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="assets/theam_assets/layouts/layout/img/avatar2.jpg" alt="...">
                                        <div class="media-body">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="assets/theam_assets/layouts/layout/img/avatar6.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="assets/theam_assets/layouts/layout/img/avatar7.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="assets/theam_assets/layouts/layout/img/avatar8.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="assets/theam_assets/layouts/layout/img/avatar9.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="assets/theam_assets/layouts/layout/img/avatar10.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="assets/theam_assets/layouts/layout/img/avatar11.jpg" alt="...">
                                        <div class="media-body">
