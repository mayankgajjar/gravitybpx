(function($)
{
		...
		for (var i = 0; i < sliderCount; i++) {
			...
			if ($("#" + sliderId).width() > 0) {
				...
				if (attachTo == "leftside") {					
					...
					$("#" + sliderId).addClass("open_popup");
					$("#" + sliderId).removeClass("close_popup");					
				} else {
					$("#" + pulloutId).animate({
						right: "0px"
					}, 1500);
	...
	function ToggleSlider () {			
		...
		if (showSlider) {
			...
			if (attachTo == "leftside") {
				...
				$("#" + thisId).addClass("open_popup");
				$("#" + thisId).removeClass("close_popup");
			} else {
				$("#" + thisPulloutId).animate({
					right: sliderWidth
				}, 1500);
				$("#" + thisId).addClass("close_popup");
				$("#" + thisId).removeClass("open_popup");
			}
		}
	...
	$.fn.sidecontent = function (settings) {
		...
		return this.each(function () {
			...
			$(".sidecontent").addClass("open_popup");			
